...
Verifies that 3-stage.ps1 properly generates characters.json with:
...
def test_characters():
    """Test that 3-stage.ps1 creates characters.json correctly"""
    ...
    # Step 2: Run 3-stage.ps1 to generate characters.json
    print("[2/5] Running 3-stage.ps1 to generate characters.json...")
    try:
        ...
        print("   [OK] 3-stage.ps1 executed successfully")
    except Exception as e:
        print(f"   [FAIL] Error running 3-stage.ps1: {e}")
        return False
    print()
    ...
    if failed == 0:
        ...
        print()
        print("3-stage.ps1 successfully:")
