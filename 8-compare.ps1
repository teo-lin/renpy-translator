# Translation Model Comparison Script
# Compares all installed models by translating the same content
# and saving results under numbered keys (r0, r1, r2, etc.) for comparison
...
Write-Host "                 Translation Model Comparison                   " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[4/5] Running comparison translations..." -ForegroundColor Yellow
Write-Host ""
