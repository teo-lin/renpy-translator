"""
Backwards-compatible wrapper around LlamaCppTranslator for Aya-23-8B.
Preserves the same public interface as aya23_translator.py so it can be
swapped in without touching any callers.
"""
...
class Aya23WrapperTranslator(LlamaCppTranslator):
